<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['updateCategory'])) 
    {
        ...
        if($flagCategory){
            ...
            $query= "UPDATE product SET Name=?, Quantity=?, Updated_By=?, Updated_At=? WHERE Id=?";
        ...
        if(!$flagCategory && isset($_POST['updateCategory'])){
            ...
            <div class="productContainer">
                ...
                <div class="productMainContainer">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
                        ...
                        <input name="ProductName" type="text" value="<?php echo $categoryName?>"> 
